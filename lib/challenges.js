...
const {createChallenge, listChallenges, getFactor, getChallenge} = require('./verify-passkeys-service');
...
router.get('/list', async (req, res) => {
    console.log("Verify Passkeys list challenges call.")
...
router.get('/:sid', async (req, res) => {
    console.log("Verify Passkeys get challenge call.")
